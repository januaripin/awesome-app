...
// in awesome_app/test/photos/data/repositories/photos_repository_impl_test.dart.
...
import 'package:awesome_app/photos/data/data_sources/photos_remote_data_source.dart'
    as _i3;
import 'package:awesome_app/photos/data/models/photo_model.dart' as _i5;
...
class MockPhotosRemoteDataSource extends _i1.Mock
    implements _i3.PhotosRemoteDataSource {
  MockPhotosRemoteDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<List<_i5.PhotoModel>> fetchPhotos(int? page) =>
      (super.noSuchMethod(Invocation.method(#fetchPhotos, [page]),
              returnValue:
                  Future<List<_i5.PhotoModel>>.value(<_i5.PhotoModel>[]))
